...
<div class="control-section" style="margin-top: 5%">
    <div id="networkDiagram" style="width: 100%; height: 600px">
        ...
        <div id="palette-space" class="sb-mobile-palette">
            ...
            <div id="dropArea">
                <ejs-button id="browse" class="e-outline" :isPrimary="true" v-on:click.native="btnClick">Importar Arquivo SVG</ejs-button>
...
function openPalette() {
    ...
    isMobile = window.matchMedia("(max-width: 550px)").matches;
    if (isMobile) {
        if (!paletteSpace.classList.contains("sb-mobile-palete-open")) {
